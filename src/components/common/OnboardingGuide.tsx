...
export default function OnboardingGuide({ locale = 'zh' }: OnboardingGuideProps) {
  ...
  const steps: OnboardingStep[] = [
    {
      ...
      titleZh: 'AI工具库',
      description: 'Browse and compare 100+ AI tools for writing, coding, design, and research. See ratings and reviews from other students.',
      descriptionZh: '浏览和对比100+款AI工具，涵盖写作、编程、设计和研究。支持按分类筛选和用户评分。',
      icon: (
    ...
    },
    {
      ...
      titleZh: '支付解决方案',
      description: '解决了留学生支付AI工具的难题！虚拟卡、礼品卡、地区定价全攻略。',
      descriptionZh: '解决了留学生支付AI工具的难题！虚拟卡、礼品卡、地区定价全攻略。',
      icon: (
    ...
    },
    {
      ...
      titleZh: '大学AI政策',
      description: '首家全面收录海外大学AI使用政策的数据库。了解你的学校允许使用哪些AI工具。',
      descriptionZh: '首家全面收录海外大学AI使用政策的数据库。了解你的学校允许使用哪些AI工具。',
      icon: (
    ...
    },
    {
      ...
      titleZh: 'Offer展示',
      description: '分享你的录取结果，查看别人的申请经验。了解不同背景被录取的可能性。',
      descriptionZh: '分享你的录取结果，查看别人的申请经验。了解不同背景被录取的可能性。',
      icon: (
    ...
    },
    {
      ...
      titleZh: 'Prompt模板库',
      description: '精选40+高质量Prompt模板，覆盖申请文书、学术论文、求职面试等场景，一键复制使用。',
      descriptionZh: '精选40+高质量Prompt模板，覆盖申请文书、学术论文、求职面试等场景，一键复制使用。',
      icon: (
        ...
        <div className="px-6 py-8">
          <div className="flex flex-col items-center text-center">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-2">
              {locale === 'zh' ? currentStepData.titleZh : currentStepData.title}
            </h3>
            <p className="text-gray-600 mb-6">
              {locale === 'zh' ? currentStepData.descriptionZh : currentStepData.description}
            </p>
            ...
            {currentStepData.link && (
              ...
              >
                {locale === 'zh' ? currentStepData.linkTextZh : currentStepData.linkText}
