...
export const sampleOffers: Offer[] = [
  ...
  },
  {
    ...
    userId: 'user-018',
    userName: '陈思远',
    userAvatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=ChenSiyuan',
    universityName: 'Stanford University',
    universityLogo: 'https://upload.wikimedia.org/wikipedia/en/thumb/4/4b/Stanford_Cardinal_logo.svg/200px-Stanford_Cardinal_logo.svg.png',
    universityCountry: 'USA',
    programName: 'PhD in Computer Science (AI/ML)',
    degree: 'PhD',
    admissionResult: 'admitted',
    scholarship: {
      amount: 65000,
    ...
    aiToolsUsed: ['Claude Opus 5', 'GPT-5.6 Sol', 'NotebookLM', 'GitHub Copilot'],
    timeline: '2026 Fall - Submitted Dec 2025, Interview Feb 2026, Result Mar 2026',
    advice: 'Stanford CS PhD 2026 Fall 申请季拿到 AI/ML track 全奖。关键经验：(1) 三篇一作 NeurIPS/ICML 论文必须有，submission 阶段也要有在投的才能跟 faculty 聊；(2) 陶瓷信不要泛泛"我是您忠实读者"，要点出他最近哪篇论文的具体 weakness + 你能怎么解决（我陶瓷信就这么写的，导师当天就回复了）；(3) 用 NotebookLM 把目标导师的 50 篇论文全部读一遍再写 research statement；(4) 面试前让 GPT-5.6 Sol 模拟 10 轮 research pitch + 5 轮 technical question；(5) 跟推荐人保持每周 update，让他们能写具体例子而不是泛泛"优秀学生"。5 万美元/年 stipend 在湾区能活但别想存钱。',
    ...
    verifiedBy: 'admin',
    verificationDocuments: ['offer_letter', 'i20'],
  },
  {
    id: 'offer-019',
    userId: 'user-019',
    userName: '林晓萌',
    userAvatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=LinXiaomeng',
    universityName: 'Imperial College London',
    universityLogo: 'https://upload.wikimedia.org/wikipedia/en/thumb/c/cc/Imperial_College_London_crest.svg/200px-Imperial_College_London_crest.svg.png',
    universityCountry: 'UK',
    programName: 'MSc Computing (Artificial Intelligence)',
    degree: 'Master',
    admissionResult: 'admitted',
    scholarship: {
      amount: 12000,
    ...
    aiToolsUsed: ['Claude', 'ChatGPT', 'DeepSeek V4-Pro'],
    timeline: '2026 Fall - Submitted Jan 2026, Result May 2026',
    advice: 'ICL Computing AI 拿到 £12000 奖学金。申请季最重要三件事：(1) PS（个人陈述）我自己写完初稿后用 Claude Opus 5 帮我重写了 5 轮，最终版质量提升显著，但**核心 ideas 和具体例子都是我的**，AI 只改表达和结构；(2) 推荐信我请了毕设导师 + 实习主管，**都给了 6 周以上**准备，他们的信里写了具体项目例子不是套话；(3) IELTS 7.5 是底线，建议**先考 UKVI 类**（不是普通 Academic），因为 IC 的语言班只有 UKVI 类接受。伦敦一年生活费约 £18-22k，省一点 £15k 也行。毕业后 2 年 PSW 签证可以工作。',
    ...
    verifiedBy: 'admin',
    verificationDocuments: ['offer_letter', 'cas'],
  },
  {
    id: 'offer-020',
    userId: 'user-020',
    userName: '黄子涵',
    userAvatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=HuangZihan',
    universityName: 'ETH Zürich',
    universityLogo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/44/ETH_Z%C3%BCrich_Logo_black.svg/200px-ETH_Z%C3%BCrich_Logo_black.svg.png',
    universityCountry: 'Switzerland',
    ...
    aiToolsUsed: ['Claude', 'GPT-5.6', 'Perplexity'],
    timeline: '2026 Fall - Submitted Nov 2025, Result Apr 2026',
    advice: 'ETH DS MSc 拿到 admission 但**没有奖学金**。ETH Master 基本不提供 merit-based scholarship，只对 PhD 给。建议预算：(1) 学费一学期 CHF 730 + 一年生活费 CHF 22-25k（包括房租保险）；(2) 暑假实习（苏黎世投行/科技公司/ETH 实验室）能 cover 一半费用；(3) 在瑞士合法打工（学生签 15h/周，约 CHF 25/h）；(4) 与其等 ETH 奖学金不如直接申请 ESOP（瑞士政府奖学金给非欧盟学生），**比 ETH 自己的钱多**。ETH 的录取线在欧陆算第一梯队，建议 GPA 3.85+、GRE 325+、IELTS 7.0+ 才稳。我用 GPT-5.6 模拟了 3 轮 interview，问的都是数学/统计题，准备充分了基本都能答。',
    ...
    verifiedBy: 'admin',
    verificationDocuments: ['offer_letter', 'residence_permit'],
  },
];
